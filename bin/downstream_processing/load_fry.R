...
# Read in alevin-fry data into a SingleCellExperiment object in R

load_fry <- function(frydir, which_counts = c('S', 'A'), verbose = FALSE) { # which_counts could also use 'U' to examine just counts confidently assigned to intronic sequence
