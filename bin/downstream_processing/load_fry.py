...
# Read in alevin-fry data in Python using scanpy
# With this function, we can load the counts we want with the following:
#   af = load_fry("quant_res")

import scanpy

def load_fry(frydir, which_counts=['S','A'], verbose=False): # which_counts could also use 'U' to examine just counts confidently assigned to intronic sequence
    import json
    import os
    import pandas as pd
